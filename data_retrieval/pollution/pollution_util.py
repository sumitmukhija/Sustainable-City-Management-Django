...
import numpy as np
import json
import data_retrieval._properties as properties

BREEZOMETER_KEY = properties.BREEZOMETER_KEY
BASE_URL = 'http://api.breezometer.com/air-quality/v2/current-conditions?key='
